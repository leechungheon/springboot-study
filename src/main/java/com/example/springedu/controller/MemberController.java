...
public class MemberController {
  ...
  @PostMapping("/member2")
  public String proc2(@ModelAttribute("member") MemberDTO dto, HttpServletRequest req,
      Model model) {
  ...
  @PostMapping("/member3")
  public String proc3(MemberDTO dto, HttpServletRequest req,
      Model model) { // memberdto 이름으로 request 객체에 보관까지 된다
    model.addAttribute("refinfo", req.getHeader("referer"));
    if (dto.getName() == null || dto.getName().equals("")) {
      dto.setName("없음");
    }
